...
export const metadata: Metadata = {
  ...
  keywords: '교육 철학, SEE Learning, NVC 모델, 비폭력대화, 요가 명상, 통합적 성장, 과학적 교육',
  openGraph: {
    title: '교육 철학 - 컴패션랩',
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <Card className="text-center">
            <CardContent className="p-6">
              ...
              <p className="text-gray-600">지적, 정서적, 신체적 영역을 통합하여 전인적 성장을 돕습니다</p>
            </CardContent>
          </Card>
      ...
      <Section background="white">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="bg-white p-8 rounded-lg shadow-lg">
            <h3 className="text-2xl font-bold text-gray-900 mb-6">NVC 4단계 프로세스</h3>
            <div className="space-y-6">
              <div className="border-l-4 border-blue-600 pl-6">
                <h4 className="font-semibold text-gray-900 mb-2">1. 관찰하기 (Observation)</h4>
                <p className="text-gray-600">판단이나 평가 없이 사실을 있는 그대로 관찰하고 표현합니다.</p>
              </div>

              <div className="border-l-4 border-purple-600 pl-6">
                <h4 className="font-semibold text-gray-900 mb-2">2. 감정 인식하기 (Feeling)</h4>
                <p className="text-gray-600">자신의 감정을 인식하고 표현하여 정서적 자각을 높입니다.</p>
              </div>

              <div className="border-l-4 border-green-600 pl-6">
                <h4 className="font-semibold text-gray-900 mb-2">3. 욕구 파악하기 (Need)</h4>
                <p className="text-gray-600">감정의 근본 원인이 되는 욕구를 파악하고 이해합니다.</p>
              </div>

              <div className="border-l-4 border-orange-500 pl-6">
                <h4 className="font-semibold text-gray-900 mb-2">4. 요청하기 (Request)</h4>
                <p className="text-gray-600">구체적이고 실현 가능한 요청을 통해 해결책을 모색합니다.</p>
              </div>
            </div>
          </div>

          <div>
            <h3 className="text-3xl font-bold text-gray-900 mb-6">NVC의 교육적 가치</h3>
            <p className="text-lg text-gray-600 mb-6">
              비폭력대화는 단순한 소통 기법을 넘어서 <strong>평화로운 관계</strong>와<strong>갈등 해결</strong>을 위한
              철학적 접근법입니다.
            </p>
            <p className="text-lg text-gray-600 mb-6">
              컴패션랩에서는 NVC를 교육에 접목하여 학생들이 효과적인 소통과 갈등 해결 능력을 기를 수 있도록 돕습니다.
            </p>

            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-purple-50 p-4 rounded-lg">
                <h4 className="font-semibold text-purple-900 mb-2">개인적 효과</h4>
              ...
              <div className="bg-green-50 p-4 rounded-lg">
                <h4 className="font-semibold text-green-900 mb-2">사회적 효과</h4>
      ...
      {/* 요가와 명상의 교육적 가치 */}
      <Section background="gray">
        <SectionHeader title="요가와 명상의 교육적 가치" subtitle="신체적 활동을 통한 몸과 마음의 통합적 성장" />

        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h3 className="text-3xl font-bold text-gray-900 mb-6">왜 요가와 명상인가?</h3>
            <p className="text-lg text-gray-600 mb-6">
              요가와 명상은 단순한 신체 운동이나 휴식 기법이 아닌,
              <strong>몸과 마음의 통합적 성장</strong>을 위한 과학적 방법입니다.
            </p>
            <p className="text-lg text-gray-600 mb-6">
              최신 신경과학 연구에 따르면, 정기적인 요가와 명상은 뇌의 구조와 기능을 긍정적으로 변화시켜 학습 능력과
              정서 조절 능력을 향상시킵니다.
            </p>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">아동 요가의 효과</h4>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">명상의 교육적 가치</h4>
                    <ul className="text-gray-600 text-sm space-y-1">
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">통합적 접근의 효과</h4>
                    <ul className="text-gray-600 text-sm space-y-1">
      ...
      <Section background="white">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h3 className="text-3xl font-bold text-gray-900 mb-6">통합적 접근의 의미</h3>
            <p className="text-lg text-gray-600 mb-6">
              컴패션랩은 <strong>SEE Learning®</strong>, <strong>NVC</strong>,<strong>요가와 명상</strong>을 독립적인
              요소가 아닌 서로 보완하는 통합적 교육 시스템으로 접근합니다.
            </p>
            <p className="text-lg text-gray-600 mb-6">
              이 세 가지 요소가 결합될 때, 학생들은 지적, 정서적, 신체적 영역에서 균형 잡힌 성장을 경험할 수 있습니다.
            </p>

            <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-lg">
              <h4 className="font-semibold text-gray-900 mb-3">통합적 접근의 효과</h4>
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <h5 className="font-medium text-gray-900 mb-2">개인적 성장</h5>
                ...
                <div>
                  <h5 className="font-medium text-gray-900 mb-2">사회적 성장</h5>
                  <ul className="text-gray-700 text-sm space-y-1">
                    <li>• 공감 능력과 관계 형성</li>
                    <li>• 갈등 해결과 소통 기술</li>
                    <li>• 사회적 책임과 시민 의식</li>
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg">
            <h3 className="text-2xl font-bold text-gray-900 mb-6">교육 과정에서의 적용</h3>
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">SEE Learning® 기반 학습</h4>
                  <p className="text-gray-600 text-sm">과학적 근거에 기반한 체계적인 사회정서윤리학습</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">NVC 소통 훈련</h4>
                  <p className="text-gray-600 text-sm">효과적인 소통과 갈등 해결 능력 개발</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">요가와 명상 활동</h4>
                  <p className="text-gray-600 text-sm">신체적 활동을 통한 몸과 마음의 균형 회복</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">통합적 성장</h4>
                  <p className="text-gray-600 text-sm">세 가지 요소의 시너지를 통한 전인적 성장</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <Section background="blue">
        <SectionHeader title="과학적 근거 및 연구 결과" subtitle="최신 연구를 통해 입증된 교육 방법론의 효과성" />
      ...
      <Section background="gradient">
        <div className="text-center">
          <h2 className="text-4xl font-bold text-gray-900 mb-6">교육 철학을 경험해보세요</h2>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            SEE Learning®, NVC, 요가와 명상을 통한 혁신적인 교육 접근법으로 몸과 마음이 모두 건강한 성장을 경험해보세요
          </p>
