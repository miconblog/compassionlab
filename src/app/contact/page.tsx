...
export default function ContactPage() {
  const faqs = [
    ...
    },
    {
      ...
      answer: '프로그램별로 차등 적용되며, 월 수업료와 등록비로 구성됩니다. 자세한 안내는 개별 상담 시 제공해드립니다.',
    },
    {
      question: '강릉 외 지역에서도 참여 가능한가요?',
      answer: '현재는 강릉 지역을 중심으로 운영하고 있으나, 향후 온라인 프로그램 확대를 계획하고 있습니다.',
    },
    {
      question: '부모님도 함께 참여할 수 있나요?',
      answer: '유아 프로그램의 경우 부모님과 함께하는 활동이 포함되어 있으며, 성인 프로그램도 별도로 운영됩니다.',
    },
    {
  ...
  return (
    <div className="min-h-screen">
      ...
      <Section background="gray">
        <SectionHeader title="강릉 지역 연락처 정보" subtitle="컴패션랩과 쉽게 연락하실 수 있습니다" />
      ...
      <Section background="white">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <div>
            <h3 className="text-2xl font-bold text-gray-900 mb-6">2024년 프로그램 일정</h3>
            <div className="space-y-4">
              <div className="border-l-4 border-blue-600 pl-6">
                <h4 className="font-semibold text-gray-900 mb-2">1분기 (3-5월)</h4>
                <p className="text-gray-600">신학기 맞춤 프로그램, 봄 특별 활동</p>
              </div>
              <div className="border-l-4 border-purple-600 pl-6">
                <h4 className="font-semibold text-gray-900 mb-2">2분기 (6-8월)</h4>
                <p className="text-gray-600">여름 방학 특별 프로그램, 야외 활동</p>
              </div>
              <div className="border-l-4 border-green-600 pl-6">
                <h4 className="font-semibold text-gray-900 mb-2">3분기 (9-11월)</h4>
                <p className="text-gray-600">가을 정기 프로그램, 성과 평가</p>
              </div>
              <div className="border-l-4 border-orange-500 pl-6">
                <h4 className="font-semibold text-gray-900 mb-2">4분기 (12-2월)</h4>
                <p className="text-gray-600">겨울 특별 프로그램, 연간 성과 총평</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">상담 신청</h4>
                  <p className="text-gray-600 text-sm">전화, 이메일 또는 온라인으로 상담을 신청합니다</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">개별 상담</h4>
                  <p className="text-gray-600 text-sm">전문 강사와 1:1 맞춤 상담을 진행합니다</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">프로그램 선택</h4>
                  <p className="text-gray-600 text-sm">상담 결과를 바탕으로 적합한 프로그램을 선택합니다</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">등록 완료</h4>
                  <p className="text-gray-600 text-sm">계약서 작성 후 등록비 납부로 등록이 완료됩니다</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* FAQ 섹션 */}
      <Section background="gray">
        <SectionHeader title="자주 묻는 질문" subtitle="많이 궁금해하시는 질문들을 모았습니다" />
                ...
                <CardContent className="p-6">
                  <details className="group">
                    <summary className="flex justify-between items-center cursor-pointer list-none">
                      <h3 className="text-lg font-semibold text-gray-900 group-open:text-blue-600">{faq.question}</h3>
                      <svg
