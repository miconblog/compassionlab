...
export default function Home() {
  const structuredData = {
    ...
    sameAs: [
      'https://www.facebook.com/compassionlab',
      'https://www.instagram.com/compassionlab',
    ],
  };
      ...
      <section className='relative h-screen flex items-center justify-center overflow-hidden'>
        ...
        <div className='relative z-10 text-center px-4 max-w-6xl mx-auto'>
          ...
          <div className='flex flex-col sm:flex-row gap-4 justify-center'>
            <button className='bg-gradient-to-r from-amber-500 to-orange-500 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:shadow-lg transition-all duration-300'>
              프로그램 시작하기
            </button>
            <button className='border-2 border-amber-500 text-amber-600 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-amber-500 hover:text-white transition-all duration-300'>
              자세히 알아보기
            </button>
          </div>
        </div>
          ...
          <div className='grid lg:grid-cols-2 gap-12 items-center mb-16'>
            <div className='text-center lg:text-left'>
              ...
              <p className='text-xl text-amber-700'>
                ...
                응용하여 요가와 명상을 교육과 접목한 몸과 마음이 모두 건강한
                성장을 돕는 프로그램을 제공합니다.
              </p>
            </div>
        ...
        <div className='max-w-6xl mx-auto px-4'>
          ...
          <div className='grid md:grid-cols-3 gap-8 text-center'>
            ...
            <div className='p-6'>
              ...
              <p className='text-xl text-amber-700'>교환 학습 프로그램 운영</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className='max-w-6xl mx-auto px-4'>
          ...
          <div className='grid md:grid-cols-5 gap-6'>
            <div className='text-center'>
              ...
              <p className='text-amber-700'>기초 교육 과정을 수강하세요</p>
            </div>
            ...
            <div className='text-center'>
              ...
              <p className='text-amber-700'>교육 자료를 다운로드하세요</p>
            </div>
            ...
            <div className='text-center'>
              ...
              <p className='text-amber-700'>지역 협력기관과 연락하세요</p>
            </div>
            ...
            <div className='text-center'>
              ...
              <p className='text-amber-700'>향후 교육 일정에 등록하세요</p>
            </div>
          ...
          <div className='grid md:grid-cols-2 gap-8'>
            <div className='bg-amber-50 p-8 rounded-lg'>
              <div className='flex items-center mb-4'>
                ...
                <div>
                  <h4 className='font-semibold text-amber-900'>다니엘 골먼</h4>
                  <p className='text-amber-700'>감정지능의 저자</p>
                </div>
              </div>
              <p className='text-amber-800 italic'>
                &ldquo;컴패션랩과 같은 프로그램들이 널리 채택되어, 더 많은
            ...
            <div className='bg-orange-50 p-8 rounded-lg'>
              <div className='flex items-center mb-4'>
                ...
                <div>
                  <h4 className='font-semibold text-amber-900'>학생</h4>
                  <p className='text-amber-700'>컴패션랩 참여자</p>
                </div>
              </div>
              <p className='text-amber-800 italic'>
      ...
      <section className='py-20 bg-gradient-to-r from-amber-500 to-orange-500 text-white'>
        <div className='max-w-4xl mx-auto px-4 text-center'>
          ...
          <p className='text-xl mb-8 text-amber-100'>
            컴패션랩과 함께 미래 교육의 새로운 패러다임을 시작하세요
          </p>
          <div className='flex flex-col sm:flex-row gap-4 justify-center'>
